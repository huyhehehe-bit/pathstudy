...
public class ProgressController {
    ...
    public ProgressController(SubjectRepository subjects, EnrollmentRepository enrollments,
    ...
    @GetMapping("/progress")
    public String progress(@RequestParam(required = false) String subject, Model model) {
